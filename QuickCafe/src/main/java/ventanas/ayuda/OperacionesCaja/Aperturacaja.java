...
public class Aperturacaja extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Apertura Caja");
        ...
        jLabel1.setFont(new java.awt.Font("BIZ UDMincho Medium", 1, 12)); // NOI18N
        jLabel1.setText("Apertura Caja creara la tabla diaria y devolvera el primer numero de ticket del dia");

        jLabel2.setFont(new java.awt.Font("BIZ UDMincho Medium", 1, 12)); // NOI18N
        jLabel2.setText("NUNCA USES LA CAJA CON LA APERTURA EN ROJO, si lo haces los tickets se mezclaran");

        jLabel3.setFont(new java.awt.Font("BIZ UDMincho Medium", 1, 12)); // NOI18N
        jLabel3.setText("De esta forma todas las ventas del dia permaneceran correctamente ordenadas");
